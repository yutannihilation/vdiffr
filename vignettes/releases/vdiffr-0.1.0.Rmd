...
visual unit tests. It accepts any object whose `print()` method draws
the object on the graphics device. It also accepts functions, and
specially integrates with ggplot2 objects. Here is an example of how
to use it:
